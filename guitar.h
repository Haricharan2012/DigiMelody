...
bool collisiong[7] = {false, false, false, false, false,false,false};
Vector2 mouseposg = {-100.0f, 100.0f};
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        //----------------------------------------------------------------------------------
         ...
         retrec.height=returnbu.height-10;
          ...
          mouseposg = GetMousePosition();
         
         
          collisiong[0] = CheckCollisionRecs(point, str1);
    if (collisiong[0])
    {
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT))
      {
        ...
        str1.x=-2;
             ...
             collisiong[1] = CheckCollisionRecs(point, str2);
    if (collisiong[1])
    {
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT))
      {
        PlaySound(strs2);
             ...
             collisiong[2] = CheckCollisionRecs(point, str3);
    if (collisiong[2])
    {
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT))
      {
        PlaySound(strs3);
             ...
             collisiong[3] = CheckCollisionRecs(point, str4);
    if (collisiong[3])
    {
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT))
      {
        PlaySound(strs4);
             ...
             collisiong[4] = CheckCollisionRecs(point, str5);
    if (collisiong[4])
    {
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT))
      {
        PlaySound(strs5);
             ...
             collisiong[5] = CheckCollisionRecs(point, str6);
    if (collisiong[5])
    {
     ...
     collisiong[6]=CheckCollisionRecs(point,retrec);
    if(collisiong[6])
      {
        if(IsMouseButtonPressed(MOUSE_BUTTON_LEFT))
         {
